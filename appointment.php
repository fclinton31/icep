...
<body ng-controller="adminController">
    <div class="col-md-12 header">
      <div class="logo"><h3 style="color:white;font-size:1.8em;text-align:left;">Appointments</h3></div> 
    </div>
    <div class="col-md-12 nav-pills-container">
        <ul class="nav nav-pills">           
            <li><a href="admin.php"><span class="glyphicon glyphicon-home"></span> </a></li>              
            <li><a href="approvedAppointment.php">History</a></li>               
 ...
 <tr>
	...
	$staffID = '980327';
	  $query = "SELECT a.* FROM appointment a,staffmember d WHERE a.doctorId = d.staffID AND d.staffID = '$staffID' AND a.status = 'pending'";
	 ...
	 <td><a href="approve.php?id=<?php echo $id; ?>" >Approve</a>
