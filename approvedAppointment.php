...
<body ng-controller="adminController">
    <div class="col-md-12 header">
      <div class="logo"><h3 style="color:white;font-size:1.8em;text-align:left;">Approved Appointments</h3></div> 
    </div>
 ...
 <tr>
	...
	$staffID = '980327';
	  $query = "SELECT a.* FROM appointment a,staffmember d WHERE a.doctorId = d.staffID AND d.staffID = '$staffID' AND a.status = 'Approved'";
