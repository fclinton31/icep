              ...
              if($userState=='Create'){
                        ...
                        if($check_user>0)
                          { 
                            ...
                            $sql = "INSERT INTO staffmember(staffID,idNumber,Firstname,Surname,Gender,Email,password,username,role)
                                   VALUES('$username','$idNumber','$FirstName','$Surname','$Gender','$Email','$password','$username','$role')";
